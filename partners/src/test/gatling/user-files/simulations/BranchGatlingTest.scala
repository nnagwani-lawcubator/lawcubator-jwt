...
class BranchGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Branch entity")
        ...
        .repeat(2) {
            ...
            .get("/services/partners/api/branches")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new branch")
            .post("/services/partners/api/branches")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "branchName":"SAMPLE_TEXT"
                , "branchCity":"SAMPLE_TEXT"
                , "branchAddress1":"SAMPLE_TEXT"
                , "branchAddress2":"SAMPLE_TEXT"
                , "branchAdmin":"0"
                , "orgID":"0"
                , "createdBy":"0"
            ...
            .repeat(5) {
                ...
                .get("/services/partners${new_branch_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created branch")
            .delete("/services/partners${new_branch_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
