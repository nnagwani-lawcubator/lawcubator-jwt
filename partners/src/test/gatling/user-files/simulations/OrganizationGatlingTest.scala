...
class OrganizationGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Organization entity")
        ...
        .repeat(2) {
            ...
            .get("/services/partners/api/organizations")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new organization")
            .post("/services/partners/api/organizations")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "orgName":"SAMPLE_TEXT"
                , "orgSize":"SMALL"
                , "orgCity":"SAMPLE_TEXT"
                , "orgState":"SAMPLE_TEXT"
                , "orgAddress1":"SAMPLE_TEXT"
                , "orgAddress2":"SAMPLE_TEXT"
                , "orgAdmin":"0"
                , "orgCompanySize":"SMALL"
                , "createdBy":"0"
            ...
            .repeat(5) {
                ...
                .get("/services/partners${new_organization_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created organization")
            .delete("/services/partners${new_organization_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
