...
export const BranchDeleteDialog = (props: IBranchDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.organizationsBranch.delete.question">
        <Translate contentKey="gatewayApp.organizationsBranch.delete.question" interpolate={{ id: branchEntity.id }}>
