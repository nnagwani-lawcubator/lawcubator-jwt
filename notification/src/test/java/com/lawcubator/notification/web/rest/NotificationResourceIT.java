package com.lawcubator.notification.web.rest;
...
import com.lawcubator.notification.IntegrationTest;
import com.lawcubator.notification.domain.Notification;
import com.lawcubator.notification.domain.enumeration.NotificationType;
...
class NotificationResourceIT {
    ...
    void createNotification() throws Exception {
        ...
        assertThat(testNotification.getOrgId()).isEqualTo(DEFAULT_ORG_ID);
    }
    ...
    void putNewNotification() throws Exception {
        ...
        assertThat(testNotification.getOrgId()).isEqualTo(UPDATED_ORG_ID);
    }
    ...
    void partialUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.orgId(UPDATED_ORG_ID);
