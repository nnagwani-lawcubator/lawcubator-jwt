...
import com.lawcubator.notification.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.lawcubator.notification.domain.Notification}.
 */
@RestController
@RequestMapping("/api")
